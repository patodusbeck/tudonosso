  ...
  module.exports = {
    ...
    async execute(interaction) {
      ...
      try {
        ...
        .setDescription('<:Foguete:1081423107488751626> Entre em contato diretamente com nossa equipe seja para esclarecer dúvidas, adquirir beneficios VIP ou reportar bugs!')
        .setFields(

          { name: '`💭` Suporte Geral', value: 'Dúvidas ou denuncias? Entre em contato.' },

          { name: '<:users:1096647887422759024> Horário de Atendimento', value: `**Segunda a Domingo das 09:00 às 23:00**
